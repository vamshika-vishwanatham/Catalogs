...
public class NewHireSelectRoleQA extends BaseClass {
	...
	@Test(priority = 4)
	public void NewHireSelectRoleSubtasks() throws InterruptedException {
		NewHireSubtaskHandling subtask = new NewHireSubtaskHandling();
		subtask.selectSubtask("NewHireSelectRole");
